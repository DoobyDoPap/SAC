...
void calculate_error()
{
    ...
    if (line_sensor_readings.adc_reading[2]  < BLACK_BOUNDARY || line_sensor_readings.adc_reading[1]  < BLACK_BOUNDARY || line_sensor_readings.adc_reading[3]  < BLACK_BOUNDARY) {
        for (int i = 0; i < 5; i++)
        {
